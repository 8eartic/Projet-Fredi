<?php
// mes_cerfas.php - page dédiée aux adhérents pour consulter leurs CERFAs.
// Elle liste les CERFAs déjà émis et permet de les visualiser ou de les télécharger.

session_start();

if (!isset($_SESSION['utilisateur']) || $_SESSION['utilisateur']['role'] !== 'adherent') {
    // Seul le rôle adhérent peut accéder à cette page.
