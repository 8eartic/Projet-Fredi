-- ====================================================
-- EXTENSION BD POUR SP3 - Gestion Tr�sorier
-- Mise � jour de sch�ma pour InfinityFree
-- Import non destructif : ajoute les tables/colonnes manquantes
-- ====================================================
...
-- ========================================
-- 1. CR�ATION DES TABLES NON EXISTANTES
-- ========================================
...
-- ========================================
-- 4. DONN�ES DE TEST SANS DUPLICATION
-- ========================================

INSERT IGNORE INTO `users` (`id`, `email`, `password_hash`, `first_name`, `last_name`, `address`, `phone`, `club_id`, `license_number`, `birth_date`, `role`, `created_at`, `league_id`, `league_name`)
VALUES
...
-- ========================================
-- 5. TRIGGERS (SUPPRIM�S POUR INFINITYFREE)
-- ========================================

-- InfinityFree ne permet pas la cr�ation de triggers SQL pour les utilisateurs.
-- Si tu veux garder la logique m�tier, ajoute-la dans le code PHP plut�t que dans la base.
